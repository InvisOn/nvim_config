...
vim.keymap.set("n", "<leader>yw", '"+yiw', { desc = "Copy word under cursor to system clipboard" })
...
vim.api.nvim_set_keymap("i", "<C-f>", " NEXT_ACTION: ", { noremap = true, silent = true, desc = "Insert next action" })
